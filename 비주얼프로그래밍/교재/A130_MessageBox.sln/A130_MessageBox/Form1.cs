...
namespace A130_MessageBox
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("느낌표와 알람 메세지 박스입니다.",
                "느낌표와 알람소리", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);

            DialogResult result1 =  MessageBox.Show("두개의 버튼을 갖는 메세지 박스입니다.",
                "Question", MessageBoxButtons.YesNo);

            DialogResult result2 = MessageBox.Show("세개의 버튼과 물음표 아이콘을 보여주는 메시지 박스입니다.",
            ...
            string msg = string.Format("당신의 선택 : {0} {1}",
